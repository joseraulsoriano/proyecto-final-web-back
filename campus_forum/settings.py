...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-pt3(i$!tmc^%gi0hz32@m)%5=o)aqtbk*ibtba!qd96&^v4@j!')
...
REST_FRAMEWORK = {
    ...
    # Permitir que las vistas sin permisos explícitos usen AllowAny por defecto
    # Esto permite que las vistas públicas funcionen sin autenticación
